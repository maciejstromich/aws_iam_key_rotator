...
def main(args):
    ...
    try:
        new_access_data = iam.create_access_key(
...
if __name__ == '__main__':
    ...
    parser.add_argument('-u', '--username', help='username to rotate credential for. This is a required field',
                        required=True)
    parser.add_argument('-c', '--config-file', help='aws config file to use, default: /root/.aws/config',
